...
# TODO: This is _clearly_ not the way to go. Maybe use a cartesian product
# or something?
for cur_use_mean_function in grid['mean_function']:
    ...
    for cur_add_bias in grid['add_bias']:
        ...
        for cur_n_kernels in grid['n_kernels']:
            ...
            for cur_n_inducing in grid['n_inducing']:
                ...
                print(f'Running with {cur_n_kernels} kernels and '
                      f'{cur_n_inducing} inducing and bias={cur_add_bias}.')
                ...
                save_dir = create_path_with_variables(
                    ...
                    mean_function=cur_use_mean_function)
